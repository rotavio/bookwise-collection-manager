      ...
      <div className="bg-white shadow-xl rounded-lg p-8 max-w-md w-full border border-border">
        ...
        <div className="space-y-3 mb-6">
          ...
          >
            ...
            <span>{socialLoading === 'google' ? 'Conectando...' : 'Cadastrar com Google'}</span>
          </Button>
          ...
          >
            ...
            <span>{socialLoading === 'facebook' ? 'Conectando...' : 'Cadastrar com Facebook'}</span>
          </Button>
          ...
          >
            ...
            <span>{socialLoading === 'twitter' ? 'Conectando...' : 'Cadastrar com Twitter'}</span>
          </Button>
        </div>
